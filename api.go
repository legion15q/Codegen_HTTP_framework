...
//$methodName: Profile -- возвращает профиль пользователя по in параметрам (по логину) параметр false auth означает что нам нет необходимости проверять залогинен ли пользователь,
//который смотрит профиль
...
//$methodName: Create -- создает нового пользователя по in параметрам (login, name, status, age) и возвращает id нового пользователя
